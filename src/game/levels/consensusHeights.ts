...
function rect(g: string[][], x0: number, y0: number, x1: number, y1: number, c: string): void {
  for (let y = y0; y < y1; y++) for (let x = x0; x < x1; x++) if (g[y] && x >= 0 && x < W) g[y][x] = c;
}
...
function build(): string[] {
  ...
  rect(g, 162, 9, 196, 10, "#"); // divider floor for upper route
  rect(g, 162, 3, 164, 9, "#"); // stairs up
  hline(g, 165, 169, 6, "-");
  rect(g, 175, 13, 178, 16, "#");
  rect(g, 184, 12, 187, 16, "#");
  rect(g, 186, 16, 190, 18, "H");
  rect(g, 195, 10, 196, 16, "G");
  rect(g, 195, 1, 196, 9, "G");
...
export const CONSENSUS_HEIGHTS: LevelData = {
  ...
  exitTileX: 238,
  rooms: [
    { id: "r1_tutorial", bounds: [0, 0, 30, 18], objectiveType: "traverse", objectiveText: "Move right. Learn to jump and shoot.", gateOnEnemies: false, gateTileX: null, billboards: ["P(DOOM) = 100%", "PAUSE EVERYTHING"] },
    { id: "r2_comments", bounds: [30, 0, 62, 18], objectiveType: "defeat_enemies", objectiveText: "Clear the Comment Section to open the gate.", gateOnEnemies: true, gateTileX: 61, billboards: ["SOURCE?", "RATIO"] },
    { id: "r3_scaffold", bounds: [62, 0, 100, 18], objectiveType: "traverse", objectiveText: "Climb the scaffolding. Avoid the coolant.", gateOnEnemies: false, gateTileX: null, billboards: ["NO COOLING TOWERS"] },
    { id: "r4_gallery", bounds: [100, 0, 134, 18], objectiveType: "defeat_enemies", objectiveText: "Survive the predictions and clear the gallery.", gateOnEnemies: true, gateTileX: 133, billboards: ["CHART GOES UP", "THEREFORE DOOM"] },
    { id: "r5_armory", bounds: [134, 0, 160, 18], objectiveType: "interact", objectiveText: "Optional: grab the Nuance Launcher over the pit.", gateOnEnemies: false, gateTileX: null, billboards: ["NUANCE IS VIOLENCE"] },
    { id: "r6_split", bounds: [160, 0, 196, 18], objectiveType: "interact", objectiveText: "Hit both switches — one up top, one below.", gateOnEnemies: false, gateTileX: 195, billboards: ["EVERYONE AGREES"] },
    { id: "r7_spire", bounds: [196, 0, 222, 18], objectiveType: "traverse", objectiveText: "Ascend the Alignment Spire.", gateOnEnemies: false, gateTileX: null, billboards: ["ALIGN OR ELSE"] },
    { id: "r8_boss", bounds: [222, 0, 240, 18], objectiveType: "defeat_enemies", objectiveText: "Defeat the Consensus Engine, then reach the exit.", gateOnEnemies: false, gateTileX: null, billboards: ["ENGAGEMENT IS TRUTH"] },
  ],
  enemies: [
    ...
    { id: "e_rh3", type: "reply_horde", tileX: 114, tileY: 8, roomId: "r4_gallery" },
    ...
    { id: "e_boss", type: "consensus_engine", tileX: 231, tileY: 6, roomId: "r8_boss" },
  ],
  pickups: [
  ...
  interactables: [
    { id: "crate_shotgun", type: "weapon_crate", tileX: 58, tileY: 15, roomId: "r2_comments", requiredPlayer: null, label: "Context Shotgun" },
    { id: "crate_launcher", type: "weapon_crate", tileX: 146, tileY: 9, roomId: "r5_armory", requiredPlayer: null, label: "Nuance Launcher" },
    { id: "sw_upper", type: "switch", tileX: 192, tileY: 8, roomId: "r6_split", requiredPlayer: null, label: "Upper Switch" },
    { id: "sw_lower", type: "switch", tileX: 192, tileY: 15, roomId: "r6_split", requiredPlayer: null, label: "Lower Switch" },
    { id: "sw_boss_l", type: "switch", tileX: 224, tileY: 11, roomId: "r8_boss", requiredPlayer: null, label: "Overload L" },
    { id: "sw_boss_r", type: "switch", tileX: 237, tileY: 11, roomId: "r8_boss", requiredPlayer: null, label: "Overload R" },
    { id: "exit", type: "exit", tileX: 238, tileY: 10, roomId: "r8_boss", requiredPlayer: null, label: "Consensus Engine Core", wTiles: 1, hTiles: 2 },
  ],
};
