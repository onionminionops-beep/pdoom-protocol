...
| `rules.coordinates`                                     | yes      | `"+x right, +y down; relative positions use self center"`                                                                             |
...
| `rules.jump.approximateHorizontalReachPx`               | yes      | `number`                                                                                                                              |
...
| `observation.rules.coordinates`                                     | yes      | `"+x right, +y down; relative positions use self center"`                                                                             |
...
| `observation.rules.jump.approximateHorizontalReachPx`               | yes      | `number`                                                                                                                              |
