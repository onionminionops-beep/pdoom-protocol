...
| `rules`                                                 | yes      | `object`                                                                                                                              |
| `rules.units`                                           | yes      | `object`                                                                                                                              |
| `rules.units.distance`                                  | yes      | `"px"`                                                                                                                                |
| `rules.units.velocity`                                  | yes      | `"px/s"`                                                                                                                              |
| `rules.units.time`                                      | yes      | `"ms"`                                                                                                                                |
| `rules.units.tileSizePx`                                | yes      | `number`                                                                                                                              |
| `rules.coordinates`                                     | yes      | `object`                                                                                                                              |
| `rules.coordinates.positiveX`                           | yes      | `"right"`                                                                                                                             |
| `rules.coordinates.positiveY`                           | yes      | `"down"`                                                                                                                              |
| `rules.coordinates.relativeTo`                          | yes      | `"self center"`                                                                                                                       |
| `rules.movement`                                        | yes      | `object`                                                                                                                              |
| `rules.movement.bodyWidthPx`                            | yes      | `number`                                                                                                                              |
| `rules.movement.bodyHeightPx`                           | yes      | `number`                                                                                                                              |
| `rules.movement.runSpeedPxPerS`                         | yes      | `number`                                                                                                                              |
| `rules.movement.maxFallSpeedPxPerS`                     | yes      | `number`                                                                                                                              |
| `rules.jump`                                            | yes      | `object`                                                                                                                              |
| `rules.jump.jumpVelocityPxPerS`                         | yes      | `number`                                                                                                                              |
| `rules.jump.gravityPxPerS2`                             | yes      | `number`                                                                                                                              |
| `rules.jump.maxRisePx`                                  | yes      | `number; min=0`                                                                                                                       |
| `rules.jump.approximateFullHoldMs`                      | yes      | `number`                                                                                                                              |
| `rules.jump.minimumHoldMs`                              | yes      | `number`                                                                                                                              |
| `rules.jump.coyoteTimeMs`                               | yes      | `number; min=0`                                                                                                                       |
| `rules.jump.jumpCutVelocityPxPerS`                      | yes      | `number`                                                                                                                              |
| `rules.dash`                                            | yes      | `object`                                                                                                                              |
| `rules.dash.speedPxPerS`                                | yes      | `number`                                                                                                                              |
| `rules.dash.durationMs`                                 | yes      | `number`                                                                                                                              |
| `rules.dash.cooldownMs`                                 | yes      | `number`                                                                                                                              |
| `rules.dash.verticalVelocity`                           | yes      | `"held at 0 while dashing"`                                                                                                           |
| `rules.weapon`                                          | yes      | `object`                                                                                                                              |
| `rules.weapon.id`                                       | yes      | `"blaster", "shotgun", "launcher"`                                                                                                    |
| `rules.weapon.label`                                    | yes      | `string`                                                                                                                              |
| `rules.weapon.damage`                                   | yes      | `number`                                                                                                                              |
| `rules.weapon.pelletsPerShot`                           | yes      | `integer; max=9007199254740991`                                                                                                       |
| `rules.weapon.rangePx`                                  | yes      | `number`                                                                                                                              |
| `rules.weapon.fireCooldownMs`                           | yes      | `number`                                                                                                                              |
| `rules.weapon.ammunition`                               | yes      | `number,null`                                                                                                                         |
| `rules.weapon.blastRadiusPx`                            | yes      | `number; min=0`                                                                                                                       |
| `rules.weapon.firing`                                   | yes      | `"horizontal along facing"`                                                                                                           |
| `rules.interaction`                                     | yes      | `object`                                                                                                                              |
| `rules.interaction.interactRangePx`                     | yes      | `number`                                                                                                                              |
| `rules.interaction.reviveRangePx`                       | yes      | `number`                                                                                                                              |
| `rules.interaction.reviveHoldMs`                        | yes      | `number`                                                                                                                              |
| `rules.interaction.reviveHealthFraction`                | yes      | `number; min=0; max=1`                                                                                                                |
| `rules.interaction.reviveRequires`                      | yes      | `"alive, not downed, in range, and held interact"`                                                                                    |
...
| `terrain.platforms`                                     | yes      | `array<object>; maxItems=6`                                                                                                           |
| `terrain.platforms[].id`                                | yes      | `string`                                                                                                                              |
| `terrain.platforms[].relativePosition`                  | yes      | `object`                                                                                                                              |
| `terrain.platforms[].relativePosition.x`                | yes      | `number`                                                                                                                              |
| `terrain.platforms[].relativePosition.y`                | yes      | `number`                                                                                                                              |
| `terrain.platforms[].widthPx`                           | yes      | `number`                                                                                                                              |
| `terrain.platforms[].surface`                           | yes      | `"solid", "oneway"`                                                                                                                   |
| `terrain.platforms[].hazardBelow`                       | yes      | `boolean`                                                                                                                             |
| `terrain.platforms[].reachableByJumpEstimate`           | yes      | `boolean`                                                                                                                             |
| `terrain.nextObstruction`                               | yes      | `object or null`                                                                                                                      |
| `progression`                                           | yes      | `object`                                                                                                                              |
| `progression.roomId`                                    | yes      | `string`                                                                                                                              |
| `progression.roomIndex`                                 | yes      | `integer; min=0; max=9007199254740991`                                                                                                |
| `progression.objectiveStatus`                           | yes      | `"active", "blocked", "complete"`                                                                                                     |
| `progression.blockedReason`                             | yes      | `string,null`                                                                                                                         |
| `progression.gate`                                      | yes      | `object or null`                                                                                                                      |
...
| `observation.rules`                                                 | yes      | `object`                                                                                                                              |
| `observation.rules.units`                                           | yes      | `object`                                                                                                                              |
| `observation.rules.units.distance`                                  | yes      | `"px"`                                                                                                                                |
| `observation.rules.units.velocity`                                  | yes      | `"px/s"`                                                                                                                              |
| `observation.rules.units.time`                                      | yes      | `"ms"`                                                                                                                                |
| `observation.rules.units.tileSizePx`                                | yes      | `number`                                                                                                                              |
| `observation.rules.coordinates`                                     | yes      | `object`                                                                                                                              |
| `observation.rules.coordinates.positiveX`                           | yes      | `"right"`                                                                                                                             |
| `observation.rules.coordinates.positiveY`                           | yes      | `"down"`                                                                                                                              |
| `observation.rules.coordinates.relativeTo`                          | yes      | `"self center"`                                                                                                                       |
| `observation.rules.movement`                                        | yes      | `object`                                                                                                                              |
| `observation.rules.movement.bodyWidthPx`                            | yes      | `number`                                                                                                                              |
| `observation.rules.movement.bodyHeightPx`                           | yes      | `number`                                                                                                                              |
| `observation.rules.movement.runSpeedPxPerS`                         | yes      | `number`                                                                                                                              |
| `observation.rules.movement.maxFallSpeedPxPerS`                     | yes      | `number`                                                                                                                              |
| `observation.rules.jump`                                            | yes      | `object`                                                                                                                              |
| `observation.rules.jump.jumpVelocityPxPerS`                         | yes      | `number`                                                                                                                              |
| `observation.rules.jump.gravityPxPerS2`                             | yes      | `number`                                                                                                                              |
| `observation.rules.jump.maxRisePx`                                  | yes      | `number; min=0`                                                                                                                       |
| `observation.rules.jump.approximateFullHoldMs`                      | yes      | `number`                                                                                                                              |
| `observation.rules.jump.minimumHoldMs`                              | yes      | `number`                                                                                                                              |
| `observation.rules.jump.coyoteTimeMs`                               | yes      | `number; min=0`                                                                                                                       |
| `observation.rules.jump.jumpCutVelocityPxPerS`                      | yes      | `number`                                                                                                                              |
| `observation.rules.dash`                                            | yes      | `object`                                                                                                                              |
| `observation.rules.dash.speedPxPerS`                                | yes      | `number`                                                                                                                              |
| `observation.rules.dash.durationMs`                                 | yes      | `number`                                                                                                                              |
| `observation.rules.dash.cooldownMs`                                 | yes      | `number`                                                                                                                              |
| `observation.rules.dash.verticalVelocity`                           | yes      | `"held at 0 while dashing"`                                                                                                           |
| `observation.rules.weapon`                                          | yes      | `object`                                                                                                                              |
| `observation.rules.weapon.id`                                       | yes      | `"blaster", "shotgun", "launcher"`                                                                                                    |
| `observation.rules.weapon.label`                                    | yes      | `string`                                                                                                                              |
| `observation.rules.weapon.damage`                                   | yes      | `number`                                                                                                                              |
| `observation.rules.weapon.pelletsPerShot`                           | yes      | `integer; max=9007199254740991`                                                                                                       |
| `observation.rules.weapon.rangePx`                                  | yes      | `number`                                                                                                                              |
| `observation.rules.weapon.fireCooldownMs`                           | yes      | `number`                                                                                                                              |
| `observation.rules.weapon.ammunition`                               | yes      | `number,null`                                                                                                                         |
| `observation.rules.weapon.blastRadiusPx`                            | yes      | `number; min=0`                                                                                                                       |
| `observation.rules.weapon.firing`                                   | yes      | `"horizontal along facing"`                                                                                                           |
| `observation.rules.interaction`                                     | yes      | `object`                                                                                                                              |
| `observation.rules.interaction.interactRangePx`                     | yes      | `number`                                                                                                                              |
| `observation.rules.interaction.reviveRangePx`                       | yes      | `number`                                                                                                                              |
| `observation.rules.interaction.reviveHoldMs`                        | yes      | `number`                                                                                                                              |
| `observation.rules.interaction.reviveHealthFraction`                | yes      | `number; min=0; max=1`                                                                                                                |
| `observation.rules.interaction.reviveRequires`                      | yes      | `"alive, not downed, in range, and held interact"`                                                                                    |
...
| `observation.terrain.platforms`                                     | yes      | `array<object>; maxItems=6`                                                                                                           |
| `observation.terrain.platforms[].id`                                | yes      | `string`                                                                                                                              |
| `observation.terrain.platforms[].relativePosition`                  | yes      | `object`                                                                                                                              |
| `observation.terrain.platforms[].relativePosition.x`                | yes      | `number`                                                                                                                              |
| `observation.terrain.platforms[].relativePosition.y`                | yes      | `number`                                                                                                                              |
| `observation.terrain.platforms[].widthPx`                           | yes      | `number`                                                                                                                              |
| `observation.terrain.platforms[].surface`                           | yes      | `"solid", "oneway"`                                                                                                                   |
| `observation.terrain.platforms[].hazardBelow`                       | yes      | `boolean`                                                                                                                             |
| `observation.terrain.platforms[].reachableByJumpEstimate`           | yes      | `boolean`                                                                                                                             |
| `observation.terrain.nextObstruction`                               | yes      | `object or null`                                                                                                                      |
| `observation.progression`                                           | yes      | `object`                                                                                                                              |
| `observation.progression.roomId`                                    | yes      | `string`                                                                                                                              |
| `observation.progression.roomIndex`                                 | yes      | `integer; min=0; max=9007199254740991`                                                                                                |
| `observation.progression.objectiveStatus`                           | yes      | `"active", "blocked", "complete"`                                                                                                     |
| `observation.progression.blockedReason`                             | yes      | `string,null`                                                                                                                         |
| `observation.progression.gate`                                      | yes      | `object or null`                                                                                                                      |
...
| `requestBudget`         | yes      | `integer; min=-9007199254740991; max=9007199254740991 or null` |
