...
| `rules`                                                 | yes      | `object`                                                                                                                              |
| `rules.units`                                           | yes      | `"distance px; velocity px/s; time ms; tile 32 px"`                                                                                   |
| `rules.coordinates`                                     | yes      | `"+x right, +y down; course left-to-right; relative positions use self center"`                                                       |
...
| `rules.jump.approximateSameHeightReachPx`               | yes      | `number`                                                                                                                              |
...
| `terrain.leftWallScan`                                  | yes      | `number; min=0`                                                                                                                       |
| `terrain.rightWallScan`                                 | yes      | `number; min=0`                                                                                                                       |
| `terrain.platforms`                                     | yes      | `array<object>; maxItems=2`                                                                                                           |
| `terrain.platforms[].id`                                | yes      | `string`                                                                                                                              |
| `terrain.platforms[].relativeLeftX`                     | yes      | `number`                                                                                                                              |
| `terrain.platforms[].relativeRightX`                    | yes      | `number`                                                                                                                              |
| `terrain.platforms[].relativeTopY`                      | yes      | `number`                                                                                                                              |
| `terrain.platforms[].surface`                           | yes      | `"solid", "oneway"`                                                                                                                   |
| `terrain.platforms[].horizontalGapPx`                   | yes      | `number; min=0`                                                                                                                       |
...
| `progression.objectiveStatus`                           | yes      | `"active", "blocked"`                                                                                                                 |
...
| `observation.rules.units`                                           | yes      | `"distance px; velocity px/s; time ms; tile 32 px"`                                                                                   |
| `observation.rules.coordinates`                                     | yes      | `"+x right, +y down; course left-to-right; relative positions use self center"`                                                       |
...
| `observation.rules.jump.approximateSameHeightReachPx`               | yes      | `number`                                                                                                                              |
...
| `observation.terrain.leftWallScan`                                  | yes      | `number; min=0`                                                                                                                       |
| `observation.terrain.rightWallScan`                                 | yes      | `number; min=0`                                                                                                                       |
| `observation.terrain.platforms`                                     | yes      | `array<object>; maxItems=2`                                                                                                           |
| `observation.terrain.platforms[].id`                                | yes      | `string`                                                                                                                              |
| `observation.terrain.platforms[].relativeLeftX`                     | yes      | `number`                                                                                                                              |
| `observation.terrain.platforms[].relativeRightX`                    | yes      | `number`                                                                                                                              |
| `observation.terrain.platforms[].relativeTopY`                      | yes      | `number`                                                                                                                              |
| `observation.terrain.platforms[].surface`                           | yes      | `"solid", "oneway"`                                                                                                                   |
| `observation.terrain.platforms[].horizontalGapPx`                   | yes      | `number; min=0`                                                                                                                       |
...
| `observation.progression.objectiveStatus`                           | yes      | `"active", "blocked"`                                                                                                                 |
